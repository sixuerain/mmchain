...
"""
class MMChainDGPGasPriceLingeringMempoolTxTest(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    def run_test(self):
        ...
        self.nodes[1].createcontract("00", 1000000, MMC_MIN_GAS_PRICE/COIN)
...
if __name__ == '__main__':
    MMChainDGPGasPriceLingeringMempoolTxTest().main()
