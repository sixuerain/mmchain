...
class MMChainNullSenderTest(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    def run_test(self):
        ...
        tx.vout = [CTxOut(0, CScript([b"\x04", CScriptNum(1000000), CScriptNum(MMC_MIN_GAS_PRICE), b"\x00", OP_CREATE]))]
