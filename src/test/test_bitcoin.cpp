...
////////////////////////////////////////////////////////////// mmchain
        ...
        globalState = std::unique_ptr<MMChainState>(new MMChainState(dev::u256(0), MMChainState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::mmchainTestNetwork)));
