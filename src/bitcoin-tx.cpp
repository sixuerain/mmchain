...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mmchain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mmchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mmchain transaction") + "\n" +
              "  mmchain-tx [options] -create [commands]   " + _("Create hex-encoded mmchain transaction") + "\n" +
              "\n";
...
static void MutateTxAddInput(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    static const unsigned int maxVout = dgpMaxBlockSize / minTxOutSz; // mmchain
