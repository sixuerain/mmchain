...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // mmchain
        hashUTXORoot.SetNull(); // mmchain
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //mmchain
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //mmchain
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //mmchain
    {
