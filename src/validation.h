...
/////////////////////////////////////////// mmchain
#include <mmchain/mmchainstate.h>
#include <mmchain/mmchainDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <mmchain/storageresults.h>


extern std::unique_ptr<MMChainState> globalState;
...
using ExtractMMChainTX = std::pair<std::vector<MMChainTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const size_t MAX_CONTRACT_VOUTS = 1000; // mmchain
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashMMChainRoot,
    const dev::h256& oldHashStateRoot, const std::vector<MMChainTransaction>& transactions);
...
class MMChainTxConverter{

public:

    MMChainTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransactionRef>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionMMChainTransactions(ExtractMMChainTX& mmchainTx);
...
private:
    ...
    MMChainTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<MMChainTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
